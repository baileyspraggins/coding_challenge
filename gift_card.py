...
def findPair(fileName, balance):
    ...
    result = slidingWindow(price_list, balance, 2)
    
    if len(result) == 0:
        print("Not possible")
    else:
        # Format return string
        print(f"{prices_dict[result[0]]} {result[0]}, {prices_dict[result[1]]} {result[1]}")

## Example
findPair('prices.txt', 4000)
